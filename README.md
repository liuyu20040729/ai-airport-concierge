...
- Multilingual Support - AI detects and responds in the user's language (Chinese/English/Japanese/Korean)
...
|----------|----------|------|--------|
| passenger | 123456 | Passenger | All features except Analytics |
| staff | 123456 | Staff | All features including Analytics |
...
- Singapore Airlines for demo flight data
